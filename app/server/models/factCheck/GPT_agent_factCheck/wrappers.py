...
class FactCheckWrapper(gym.Wrapper):
  def __init__(self, env):
    super().__init__(env)
    self.claim = None
    
  def reset(self, claim, seed=None, return_info=False, options=None, idx=None):
    self.env.reset(claim, seed=seed, return_info=return_info, options=options)
    self.claim = claim
